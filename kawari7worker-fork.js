...
(function () {
  ...
  function workerRoutine() {
    var Kawari7 = require("kawari7.js"),
      ...
      function r(r, e) {
        var n = [],
            ...
            t = !1,
            o = void 0;try {
          for (var u, a = r[Symbol.iterator](); !(i = (u = a.next()).done) && (n.push(u.value), !e || n.length !== e); i = !0) {}
        } catch (r) {
          t = !0, o = r;
        } finally {
          try {
  ...
  function clientRoutine(workerMaker) {
    var Kawari7Worker = function (_NativeShioriWorkerCl) {
      _inherits(Kawari7Worker, _NativeShioriWorkerCl);

      _createClass(Kawari7Worker, [{
        key: 'worker',
        get: function get() {
          return this._worker;
        }
      ...
      function Kawari7Worker(fs, workerErrorHandler) {
        _classCallCheck(this, Kawari7Worker);

        // no fs with fork
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Kawari7Worker).call(this));

        _this._worker = new WorkerClient(workerMaker(), workerErrorHandler);
        return _this;
      }

      return Kawari7Worker;
    }(NativeShioriWorkerClient);

    if (typeof window !== 'undefined') {
      window.Kawari7Worker = Kawari7Worker;
      if (window.ShioriLoader) {
        window.ShioriLoader.shiories.kawari7 = Kawari7Worker;
      } else {
        throw new Error("load ShioriLoader first");
      }
    } else {
      // node.js
      module.exports = Kawari7Worker;
      if (typeof require !== 'undefined') {
        var ShioriLoader = require('shioriloader');
        ShioriLoader.shiories.kawari7 = Kawari7Worker;
      }
    }
  }
